...
namespace CS529
{
	...
	// Class Definition:
	class BehaviorMusic : public Behavior
	{
	...
	public:
		...
		BehaviorMusic(const BehaviorMusic* other);
	...
	public:
		...
		// Public Functions:
	public:
		// @brief Read the properties of a BehaviorMusic component from a stream.
	...
	private:
		...
		BehaviorMusic* Clone() const override { return new BehaviorMusic(this); }
